...
public class ChooseDict extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        uiListDicts = (ListView) findViewById(R.id.list);
    ...
    protected void onResume() {
        ...
        ArrayAdapter<Dictionary> adapter = new ArrayAdapter<Dictionary>(this,
            ...
            dicts);
        uiListDicts.setAdapter(adapter);
        ...
        ((Button) dialog.findViewById(R.id.btnAcceptDelete))
            .setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ArrayAdapter<Dictionary> adapter = (ArrayAdapter<Dictionary>) uiListDicts.getAdapter();
