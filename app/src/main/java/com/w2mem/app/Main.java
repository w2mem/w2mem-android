...
public class Main extends Activity implements View.OnClickListener {
	...
	public void login(Dialog dialog, String login, String password, boolean saveUserInfo) throws IOException {
		...
		if (isOnline()) {
			dialog.dismiss();
			boolean loginSuccessful = Connector.connect(login, password);
			if (loginSuccessful) {
				// user login is being saved automatically regardless of checkbox state
